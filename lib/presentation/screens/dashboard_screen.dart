...
class DashboardScreen extends StatelessWidget {
  ...
  @override Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(title: const Text('MindTamer')),
      body: Center(child: Wrap(spacing:12, runSpacing:12, children: const [
...
class _NavCard extends StatelessWidget {
  ...
  @override Widget build(BuildContext context){
    return Card(child: InkWell(onTap: ()=>context.go(route), child: SizedBox(width:140, height:90, child: Center(child: Text(label, style: const TextStyle(fontSize:18))))));
  }
}
