...
class ItemDef {
  ...
  final String? equipSlot; // optional override for repo slot name (e.g., 'neck', 'ring')
  const ItemDef({required this.key, required this.iconPath, required this.slot, this.classAffinity, this.equipSlot});
}
